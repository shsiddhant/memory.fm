...
dict_valid = {"username": "sid", "scrobbles": [data_valid], "tz": "Asia/Kolkata"}
...
class TestScrobbleLog:
    def test_from_dict(self):
        ...
        assert scrobble_log.meta["memory.fm_version"] == mfm._version.__version__

    def test_validate(self):
        dict_data = {
            "username": "sid",
            "scrobbles": [{"track": "Tr1", "artist": "Ar1", "album": None}],
            "tz": "Etc/UTC",
        }
